...
module.exports = function (config) {
    config.set({
        ...
        files: [
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/libs/jquery/jquery-1.10.1.min.js',
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/libs/jquery/plugins/jquery.cookie.min.js',
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/common/jquery.custom.js',
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/common/jquery.ns.external.js',
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/common/core.init.js',
            '../../../../../cms-base/cms-core/core-view/core-design/src/content/jcr_root/etc/designs/site/_core/js/common/core.utils.js',
            ...
            'src/content/jcr_root/etc/designs/site/micro/js/dreamsresorts/components/controllers/*.js',
            '../micro-app/src/content/jcr_root/apps/site/micro/**/**/**/clientLibs/*.js',
            'src/content/jcr_root/etc/designs/site/micro/js/dreamsresorts/components/services/*.js',
        ...
        exclude: [
            'src/test/microTestTemplate.js',
            'src/content/jcr_root/etc/designs/site/micro/js/dreamsresorts/components/controllers/microSampleEmailerController.js',
            'src/content/jcr_root/etc/designs/site/micro/js/dreamsresorts/components/controllers/microColorPaletteController.js'
        ],
