/**
 * @class CQ.form.MultiMultiCompositeField
 * @extends CQ.form.CompositeField
 * The MultiMultiCompositeField is an editable list of a set of form fields for editing a list of nodes with their properties. 
 ...
 *
 * @constructor
 * Creates a new MultiMultiCompositeField.
 * @param {Object} config The config object
 */
CQ.form.MultiMultiCompositeField = CQ.Ext.extend(CQ.form.CompositeField, {
    ...
    constructor: function(config) {
        ...
        CQ.form.MultiMultiCompositeField.superclass.constructor.call(this,config);
    ...
    initComponent: function() {
        CQ.form.MultiMultiCompositeField.superclass.initComponent.call(this);
    },
    ...
    getValue: function() {
        ...
        this.items.each(function(item, index) {
            if (item instanceof CQ.form.MultiMultiCompositeField.Item) {
    ...
    afterRender : function(){
        CQ.form.MultiMultiCompositeField.superclass.afterRender.call(this);
        this.doLayout();
    },
    validate: function () {
        return true;
...
/**
 * @private
 * @class CQ.form.MultiMultiCompositeField.Item
 * @extends CQ.Ext.Panel
 * The MultiMultiCompositeField.Item is an item in the {@link CQ.form.MultiMultiCompositeField}.
 * This class is not intended for direct use.
 * @constructor
 * Creates a new MultiMultiCompositeField.Item.
 * @param {Object} config The config object
 */
CQ.form.MultiMultiCompositeField.Item = CQ.Ext.extend(CQ.Ext.Panel, {

    /**
     * @cfg {String} name
     * @member CQ.form.MultiMultiCompositeField.Item
     * Name of this item.
     */
    /**
     * @cfg {String} prefix
    ...
    constructor: function(config) {
        ...
        CQ.form.MultiMultiCompositeField.Item.superclass.constructor.call(this, config);
        ...
        this.getFieldPanel().items.each(function(item) {
            ...
            } else if (item.checkboxBoolean && item.checkboxBoolean.rawFieldName) {
            	// Special case for custom checkbox boolean.
            	this.fields.add(item.checkboxBoolean.rawFieldName, item);
            }
        }, this);
     ...
     * @param item {CQ.form.MultiMultiCompositeField.Item} The item to reorder above
     * @member CQ.form.MultiMultiCompositeField.Item
     */
    ...
    setValue: function(valueMap) {
        this.fields.each(function(f) {
        	var rawFieldName = f.rawFieldName;
        	if (f.checkboxBoolean) {
        		// Special handling for custom checkbox Boolean
        		rawFieldName = f.checkboxBoolean.rawFieldName;
        	}
        	
        	var theValue = valueMap[rawFieldName];
        	
            if (typeof theValue !== 'undefined') {
                f.setValue(theValue);
                
            	if (f.checkboxBoolean) {
                    // also consider special handling of custom checkbox boolean
            		// TODO: figure out how to get this back into the original checkbox boolean instead of doing it here.  setValue should handle it all.
            		f.checkboxBoolean.setValue(theValue);            		
            	}
...
CQ.Ext.reg("multimulticompositefielditem", CQ.form.MultiMultiCompositeField.Item);
